...
\begin{DoxyCompactList}\small\item\em Repeats the menu and all functions. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em name} & Name of the program. \\
\hline
{\em version} & Version of the program. \\
\hline
{\em students} & Array to store the existing students. \\
\hline
\end{DoxyParams}
